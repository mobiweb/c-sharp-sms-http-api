...
// Send SMS Example: Send SMS Example: Multiple Recipients SMS
// @copyright 1999 - 2014 Mobiweb Ltd.--%>

namespace MobiWeb
{
    class MultipleRecipientSMS
    {
        static void Main(string[] args)
        {
            ...
            postData += "&phone=recipient1,recipient2";                         //The full International mobile number of the
