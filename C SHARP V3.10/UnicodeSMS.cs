...
//.---------------------------------------------------------------------------.
//|  Software: HTTP API - Unicode SMS Example					              |
//|  Version: 	3.10														  |
...
namespace MobiWeb
{
    class UnicodeSMS
    {
        static void Main(string[] args)
        {
            ...
            postData += "&msgtext=063506280627062D002006270644062E064A0631";    //The SMS Message text. SMS Message text 'Good Morning' in Arabic.
            ...
            postData += "&charset=6";                                           //The SMS Message text Charset.
